...
public class GameService {
    private static final String TOKEN = "Bearer 2raywpdhg82z271olm88ccqub3x7fa";
    private static final String CLIENT_ID = "tzci3f4xnbzlj9rayzd0mct0ehwvmf";
    ...
    public Map<String, List<Item>> searchItems(String gameId) throws TwitchException {
        //String is the itemType: stream, clip, video
