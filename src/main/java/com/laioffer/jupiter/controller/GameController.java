...
@Controller
//gameController is to find a specific game and get gameId or get a topGame list
public class GameController {
    ...
    public void getGame(@RequestParam(value = "game_name", required = false) String gameName, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            if (gameName != null) {
                //because searchGame() and topGames() return values are different, one is List<Game>, the other is Game,
                //so we cannot use @ResponseBody this annotation to convert object to JSON format that front-end need
